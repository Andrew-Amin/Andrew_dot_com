...
public class CameraScanner extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    private boolean checkPermission() {
        return (ContextCompat.checkSelfPermission(CameraScanner.this, CAMERA) == PackageManager.PERMISSION_GRANTED);
    }
 ...
 /*   public void onRequestPermissionResult(int requestCode, String permission[], int grantResults[]) {
    ...
    public void handleResult(Result result) {
        ...
        cameraSearchFragment.searchResult.setText(scanResult);
        onBackPressed();
       /* Intent intent = new Intent(getApplicationContext() , cameraSearchFragment.class );
